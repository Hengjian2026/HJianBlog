...
这里利用Deepseek生成一段用R语言的画图代码，利用代码读取样例数据来调整图形。
    ...
    请帮我写一段完整、可直接运行的 R 脚本，完成以下任务：

上述提示词，可以生成类似这样的R语言代码

    # 加载必要的包

3.图例效果

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFbZ1j2ibmyWGuoWWic2O3XCK8jD4SibAxbsYAR0fZnCyYiaXG1wRNeAp78w/640?wx_fmt=png)

  

运行上述代码后可以使用鼠标拖动3D图，改变图的视角和方位来方便观察。上图是代码执行后的初始图形。下面则是转动后的效果：

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFjj7Vibdiat2N9KWYF2EPnhjLznAUxibGvbkr0rod6F5EiaGuMWyO4icIG1g/640?wx_fmt=png&from=appmsg)
