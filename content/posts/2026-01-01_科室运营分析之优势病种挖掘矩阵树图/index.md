...
![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFSKZGpow3bLyrxNLiawZHAN4n8N258zUbhDqc7HdWZjhI1gKEOXzgEiaw/640?wx_fmt=png)
...
我们采用前面公众号用到的病案数据病案数据.xlsx，由于数据结构，我们按照从“院区”--“科室”--“诊断”的层级进行矩阵树状图的制作，以患者例数表示矩阵树状图的格子大小，以病种费用作为颜色标识（可以用来识别大费用的病组）。
...
![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFyDwfEph4uuEr65Qv28baI1TMbrjnQXZStJUibyRh0M9OecgRlW5E11Q/640?wx_fmt=png)
...
上述提示词，deepseek会输出一段R语言代码（python等其他代码也是类似）：

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFIWFGzGhceG6GARsib9ibno0iagG7cKozdoibvbgdke1y59ZfVNaFaDeMgw/640?wx_fmt=png)

熟悉R语言代码的朋友可以稍作调整，读取数据，进行绘图。这里选择shiny画图，可以形成交互式的效果，形如：

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibQEIKib5iasnP7P5icdQOTK7RFFGDjwqibDb9vV1jfu9YQ7dGPFwvZpNCaOtVafHqbPsjgYjnpianyQ89A/640?wx_fmt=png)
...
[医疗质量管理主要因素分析（帕累托图）](https://mp.weixin.qq.com/s?__biz=MzkzNjkyNjg1Ng==&mid=2247486684&idx=1&sn=5423c7ac45204cd0dead73cb2f00a778&scene=21#wechat_redirect)
