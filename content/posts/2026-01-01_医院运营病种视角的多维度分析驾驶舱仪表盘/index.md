...
原创 Hi您好 恒健知行 2025-10-27 05:00 安徽

> 原文地址: [https://mp.weixin.qq.com/s/nx4sq-C7F1XiVksCE4i8xA](https://mp.weixin.qq.com/s/nx4sq-C7F1XiVksCE4i8xA)

很多医院都有一些驾驶舱报表系统，这些系统会提供对医院综合管理、或某个专业监管的指标的集中展示。对于DIP病种数据我们同样可以通过驾驶舱仪表盘的方式为医院运营管理提供信息。

1.样例数据

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibTGAj4WefuET0e3TMib5LcD9RC8oUbvr2mfHUWk4rMFfqO7FnCUCjdIkjcib4uNDibodzpEeuCIYRbsw/640?wx_fmt=png)
...
如下提问：
    ...
    你是医院运营分析专家，请根据样例数据，使用R shiny设计一个仪表盘原型，可以在Rstudio中执行，要求：

3.完整驾驶舱

驾驶舱的好处是可以进行筛选条件进行动态查看数据，可以根据维度进行筛选，集成Tab页切换功能，可以查看各个指标度量下的科室排名；也可以从全院或科室视角查看病种、平均住院日、费用等维度下的数据情况。

![](https://mmbiz.qpic.cn/mmbiz_png/IvumIlxgDibTGAj4WefuET0e3TMib5LcD9SsEFicopOCeHG6zV6j0D4DeWW5HxRxzfcVbHSU9pUJUa0XF0tJkJ8tQ/640?wx_fmt=png)
